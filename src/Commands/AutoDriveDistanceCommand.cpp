...
AutoDriveDistanceCommand::AutoDriveDistanceCommand(int dist) {
...
void AutoDriveDistanceCommand::Initialize() {
	isCommandDone = false;
...
void AutoDriveDistanceCommand::Execute() {
...
bool AutoDriveDistanceCommand::IsFinished() {
...
void AutoDriveDistanceCommand::End() {
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void AutoDriveDistanceCommand::Interrupted() {
